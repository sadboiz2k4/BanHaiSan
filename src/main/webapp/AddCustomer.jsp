...
<head>
  ...
  <script src="<c:url value='fontawesome/js/AddCus.js'/>"></script>
</head>
...
<main class="app-content">
  <div class="app-title">
    <ul class="app-breadcrumb breadcrumb">
      <li class="breadcrumb-item"><a href="<c:url value='customer'/>">Danh sách khách hàng</a></li>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        ...
        <div class="tile-body">
          <form class="row" id="addCustomerForm" action="<c:url value='addcustomer'/>" method="POST">
            <div class="form-group col-md-4">
              <label class="control-label">ID khách hàng</label>
              <input class="form-control" type="text" name="customerID" pattern="#KH\d{3}" title="Định dạng: #KH000" required>
            </div>
            <div class="form-group col-md-4">
            ...
            <div class="form-group col-md-4">
              ...
              <input class="form-control" type="text" name="wardOrCommune">
            </div>
            <div class="form-group col-md-4">
            ...
            <div class="form-group col-md-4">
              ...
              <input class="form-control" type="text" name="provinceOrCity">
            </div>
            <div class="form-group col-md-4">
              <label class="control-label">Số điện thoại</label>
              <input class="form-control" type="tel" name="phoneNumber" pattern="[0-9]{10}" title="Số điện thoại gồm 10 chữ số" required>
            </div>
            <div class="form-group col-md-4">
            ...
            <div class="form-group col-md-4">
              ...
              <input class="form-control" type="number" name="point" value="0" min="0">
            </div>
            ...
            <div class="form-group col-md-12">
              ...
              <a class="btn btn-cancel" href="<c:url value='customer'/>">Hủy bỏ</a>
            </div>
          </form>
        </div>
      </div>
...
if (!customerID.match(/#KH\d{3}/)) {
swal("Lỗi!", "Mã khách hàng không đúng định dạng (vd: #KH001)", "error");
return;
}
...
.catch(error => {
swal("Lỗi!", "Có lỗi xảy ra khi thêm khách hàng: " + error.message, "error");
});
});

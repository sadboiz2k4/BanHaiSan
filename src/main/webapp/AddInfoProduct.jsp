...
<html lang="vi">
<head>
    <title>Thêm thông tin sản phẩm | Quản trị Admin</title>
    <meta charset="utf-8">
...
<main class="app-content">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title">Thêm thông tin sản phẩm</h3>
                <div class="tile-body">
                    <form class="row" action="add-more-info-product" method="post">
                        <input type="hidden" name="action" value="add">
                        <div class="form-group col-md-3">
                            <label class="control-label">Mã sản phẩm</label>
                            <input value="${detail.id}" class="form-control" type="text" name="productID" readonly>
                        </div>
                        <div class="form-group col-md-3">
                            <label class="control-label">Tên sản phẩm</label>
                            <input value="${detail.name}" class="form-control" type="text" name="productName" readonly>
                        </div>
...
<%--                        </div>--%>
                        ...
                        <div class="form-group col-md-3">
                            <label class="control-label">Danh mục</label>
                            <input value="${category}" class="form-control" type="text" name="productName" readonly>
                        </div>

                        <div class="form-group col-md-3">
                            <label class="control-label">Nhà cung cấp</label>
                            <input value="${supplier}" class="form-control" type="text" name="productName" readonly>
                        </div>

                        <div class="form-group col-md-3">
                            <label class="control-label">Giá bán</label>
                            <input value="${detail.price}" class="form-control" type="number" name="price" readonly>
                        </div>
